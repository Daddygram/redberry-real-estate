...
import pfp from "../assets/Beautiful young woman looking serious.png";
  ...
  return (
    <div className="mt-[29px] flex gap-[68px] text-darkGrey">
        ...
        <div className="w-full max-w-[839px]">
            <div className="relative">
                <span className="absolute top-[41px] left-[41px] px-[26.5px] py-[8.5px] bg-black/50 text-white font-medium text-[1.25rem] leading-6 rounded-[20px]">
                    <p className="-translate-y-[2px]">იყიდება</p>
                </span>
                <img src={image2} alt="" className="h-[670px] object-cover rounded-t-[14px]" />
            </div>
        ...
        <div className="mt-[30px]">
            {/* price */}
            <span className="text-black font-bold text-[3rem] leading-[3.6rem]">80, 458 ₾</span>
            {/* deeper details */}
            <div className="mt-6 flex flex-col gap-4 text-[1.5rem] leading-[1.75rem]">
                <div className="mt-[6px] flex items-center gap-2">
                    ...
                    <p className=" leading-[1.2rem] ">თბილისი, ი. ჭავჭავაძის 53</p>
                </div>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <p className=" leading-[1.2rem] ">ფართი 55 მ<span className="mb-[7px] text-[0.625rem] leading-[0.75rem]">2</span></p>
                </div>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <p className=" leading-[1.2rem] ">საძინებელი 2</p>
                </div>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <p className=" leading-[1.2rem] ">საფოსტო ინდექსი 0160</p>
                </div>
            </div>
            ...
            <div className="max-w-[503px]">
                ...
                <div className="mt-[50px] mb-5 px-5 py-6 border border-solid border-grey rounded-lg">
                    <div className="flex items-center gap-[14px]">
                        <img src={pfp} alt="agent" className="w-[72px] h-[72px] rounded-full overflow-hidden" />
                        <div>
                            <span className="text-black leading-[1.2rem]">სოფიო გელოვანი</span>
                    ...
                    <div className="mt-4">
                        <div className="flex items-center gap-[5px]">
                            ...
                            <span className="text-[0.875rem] leading-[1.05rem]">sophio.gelovani@redberry.ge</span>
                        </div>
                        <div className="mt-1 flex items-center gap-[5px]">
                            ...
                            <span className="text-[0.875rem] leading-[1.05rem]">577 777 777</span>
                        </div>
                    </div>
                </div>
